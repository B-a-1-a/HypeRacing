...
export default function HomePage() {
  ...
  const drivers: Driver[] = [
    { code: "PIA", name: "Oscar Piastri", team: "McLaren", points: 131 },
    { code: "NOR", name: "Lando Norris", team: "McLaren", points: 115 },
    { code: "VER", name: "Max Verstappen", team: "Red Bull Racing", points: 99 },
    { code: "RUS", name: "George Russell", team: "Mercedes", points: 93 },
    { code: "LEC", name: "Charles Leclerc", team: "Scuderia Ferrari", points: 53 },
    { code: "ANT", name: "Kimi Antonelli", team: "Mercedes", points: 48 },
    { code: "HAM", name: "Lewis Hamilton", team: "Scuderia Ferrari", points: 41 },
    { code: "ALB", name: "Alexander Albon", team: "Williams Racing", points: 30 },
    { code: "OCO", name: "Esteban Ocon", team: "Haas", points: 14 },
    { code: "STR", name: "Lance Stroll", team: "Aston Martin", points: 14 },
    { code: "TSU", name: "Yuki Tsunoda", team: "Red Bull Racing", points: 9 },
    { code: "GAS", name: "Pierre Gasly", team: "Alpine", points: 7 },
    { code: "SAI", name: "Carlos Sainz", team: "Williams Racing", points: 7 },
    { code: "HUL", name: "Nico Hulkenberg", team: "Kick Sauber", points: 6 },
    { code: "BEA", name: "Oliver Bearman", team: "Haas", points: 6 },
    { code: "HAD", name: "Isack Hadjar", team: "Racing Bulls", points: 5 },
    { code: "ALO", name: "Fernando Alonso", team: "Aston Martin", points: 0 },
    { code: "LAW", name: "Liam Lawson", team: "Racing Bulls", points: 0 },
    { code: "DOO", name: "Jack Doohan", team: "Alpine", points: 0 },
    { code: "BOR", name: "Gabriel Bortoleto", team: "Kick Sauber", points: 0 },
  ]

  // Constructor standings
  const constructors: Constructor[] = [
    { name: "McLaren", logo: "McLaren", points: 246 },
    { name: "Mercedes", logo: "Mercedes", points: 141 },
    { name: "Red Bull Racing", logo: "RedBull", points: 105 },
    { name: "Scuderia Ferrari", logo: "Ferrari", points: 94 },
    { name: "Williams Racing", logo: "Williams", points: 37 },
    { name: "Haas", logo: "Haas", points: 20 },
    { name: "Aston Martin", logo: "Aston Martin", points: 14 },
    { name: "Racing Bulls", logo: "RB", points: 8 },
    { name: "Alpine", logo: "Alpine", points: 7 },
    { name: "Kick Sauber", logo: "Sauber", points: 6 },
  ]
